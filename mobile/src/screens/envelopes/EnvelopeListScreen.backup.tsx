...
import { Text, Card, Chip, Searchbar, FAB, ActivityIndicator, Badge, Divider, Menu, IconButton } from 'react-native-paper';
...
const EnvelopeListScreen = () => {
  ...
  // Use the EnvelopeSkeletonList component for loading states
  ...
  // ScrollableChipGroup component definition
  const ScrollableChipGroup = ({ options, selectedValue, onSelect }: {
    options: Array<{ label: string; value: string }>;
    selectedValue: string;
    onSelect: (value: string) => void;
